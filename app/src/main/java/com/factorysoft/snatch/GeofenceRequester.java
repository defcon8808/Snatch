...
/**
 * Created by defcon8808 on 14. 6. 4.
 */
public class GeofenceRequester implements
     ...
     *
     * @param geofences A List of one or more geofences to add
     * @param id Memo number in sqlite
     */
    public void addGeofences(List<Geofence> geofences, int id) throws UnsupportedOperationException {
    ...
    private PendingIntent createRequestPendingIntent() {
        queryDB((Context)mActivity, _id);

        // Create an Intent pointing to the IntentService
        Intent intent = new Intent(mActivity, FindLocateIntentService.class);
        intent.putExtra("title", title);
        intent.putExtra("content", content);

        Log.d("GeofenceRequester", "title : " + title + ", content : " + content);
